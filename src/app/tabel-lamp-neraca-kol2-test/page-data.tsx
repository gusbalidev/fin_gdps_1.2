  ...
  return (
    <>
      <div>
        ...
        <Divider />
        <h2 className="text-lg font-bold pt-2 pb-2 text-blue-600 dark:text-orange-500 opacity-0">AKTIVA-T-L-2</h2>
        <Suspense fallback={<Loading section="AKTIVA TIDAK LANCAR - 2" />}>
          {/* <AktivaTidakLancar /> */}
          <NeracaDataX title="ATL2" titleTotal="TANAH DALAM PENYELESAIAN" type={1} group={15} start={startFirst} end={end} />
          <NeracaDataDetailX title="ATL2" titleTotal="TDP" type={1} group={15} start={startFirst} end={end} />
          <div className="h-2" />
          <NeracaDataX title="ATL2" titleTotal="GEDUNG DALAM PENYELESAIAN" type={1} group={16} start={startFirst} end={end} />
          <NeracaDataDetailX title="ATL2" titleTotal="GDP" type={1} group={16} start={startFirst} end={end} />

          <NeracaDataSubX title="ATL2" titleTotal="ATL" type={1} group={3} start={startFirst} end={end} />
        </Suspense>
