        ...
        <>
            <div className="flex flex-row">
                ...
                <div className="w-3/4 pr-2">
                    ...
                    <Suspense fallback={<Loading section="Akun Saldo Awal" />}>
                        <NeracaDataX title="akun-saldo-awal" titleTotal="SAw" type={accType} group={accGroup} start={startPrevX} end={endPrev} />
                    </Suspense>
                ...
                <div className="w-3/5 pr-2">
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        {/* kolom DEBET */}
                        <Suspense fallback={<Loading section="Debet" />}>
                            <NeracaDataDebit title="debit" titleTotal="D" type={accType} group={accGroup} start={start} end={end} />
                        </Suspense>

                        {/* kolom KREDIT */}
                        <Suspense fallback={<Loading section="Kredit" />}>
                            <NeracaDataCredit title="credit" titleTotal="K" type={accType} group={accGroup} start={start} end={end} />
                        </Suspense>
                ...
                <div className="w-1/4">
                    ...
                    {/* kolom Saldo Akhir */}
                    <Suspense fallback={<Loading section="saldo-akhir" />}>
                        <NeracaDataX2 title="saldo-akhir" titleTotal="SAk" type={accType} group={accGroup} start={start} end={end} />
                    </Suspense>
