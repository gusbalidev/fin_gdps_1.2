...
function ShowCFData() {
    ...
    // const { start, end, periodeOn, startPrev, endPrev, titleMonthYear, titlePrevMonthYear } = useNeracaSaldoContext();
    ...
    return (
        <>
            {/* PENERIMAAN */}
            <h1 className="text-xl font-bold pt-4 pb-2 dark:text-blue-500 opacity-0">PENERIMAAN</h1>
            <Divider />
