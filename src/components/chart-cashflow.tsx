...
export function ChartCashflow() {
    ...
    const month3 = getMonthDates(2);
        

    // const start = "2025-08-01"
    // const end = "2025-08-31"

    console.log('Start1 Date:', month1.start);
    console.log('End1 Date:', month1.end);
    console.log('Start2 Date:', month2.start);
    console.log('End2 Date:', month2.end);
    ...
    // Function to safely get number from CountCashFlow result    
