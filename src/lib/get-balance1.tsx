...
const GetBalance1 = ({ title, titleTotal, id }: { title: string; titleTotal: string; id: number }) => {

    const { saldoAwal, setSaldoAwal, setSaldoAwal2 } = useSaldoAwalContext();
