...
// Calculate and display the total Aset Bersih Awal based on the current and previous Periods
const TotalABAwal = ({ isCurrent, titleTotal }: { isCurrent: boolean; titleTotal: string }) => {
